// src/components/ChemicalsMaterialsReportsPage.js
import React, { useState, useEffect } from 'react';
import { Link } from 'react-router-dom';
import { useTranslation } from 'react-i18next';
// Import the JSON data directly
import chemicalsMaterialsData from '../data/chemicals.json';

const ChemicalsMaterialsReportsPage = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      setReports(chemicalsMaterialsData);
      setLoading(false);
    }, 300);
  }, []);
  ...
  const ReportCard = ({ report }) => {
    ...
    return (
      <div className="group bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col">
        <div className="h-48 bg-gradient-to-br from-purple-400 to-orange-500 flex items-center justify-center">
  ...
  const ListItem = ({ report }) => {
    ...
    return (
      <div className="bg-white rounded-lg border border-gray-200 hover:shadow-lg transition-all duration-300 hover:border-purple-200">
        <div className="p-6">
          <div className="flex items-start justify-between">
            <div className="flex-1 pr-6">
              <div className="flex items-center mb-2">
                <span className="marg-5 inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800 mr-3">
                  {report.type}
                </span>
            ...
            {[...Array(6)].map((_, i) => (
              <div key={i} className="animate-pulse">
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                  <div className="h-48 bg-gradient-to-br from-purple-50 to-orange-50"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="p-5 py-12 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Comprehensive insights into chemicals, advanced materials, and innovative manufacturing processes driving industry transformation
          </p>
        </div>
        ...
        {displayedReports.length > 0 ? (
          ...
          <div className="text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-2">No chemicals & materials reports found</h3>
        ...
        <div className="border-t border-gray-200 pt-8 pb-12">
          <div className="text-center">
            <p className="text-lg text-gray-600">
              <span className="font-semibold text-purple-600">{reports.length}</span> chemicals & materials market research reports available
            </p>
            <p className="text-sm text-gray-500 mt-2">
              Covering advanced materials, chemical processes, sustainability trends, and emerging technologies
            </p>
          </div>
        </div>
      </div>
...
export default ChemicalsMaterialsReportsPage;