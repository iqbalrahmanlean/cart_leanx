// src/components/ConsumerGoodsServicesReportsPage.js
import React, { useState, useEffect } from 'react';
import { Link } from 'react-router-dom';
import { useTranslation } from 'react-i18next';
// Import the JSON data directly
import consumerGoodsServicesData from '../data/consumer.json';

const ConsumerGoodsServicesReportsPage = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      setReports(consumerGoodsServicesData);
      setLoading(false);
    }, 300);
  }, []);
  ...
  const ListItem = ({ report }) => {
    ...
    return (
      <div className="bg-white rounded-lg border border-gray-200 hover:shadow-lg transition-all duration-300 hover:border-indigo-200">
        <div className="p-6">
          <div className="flex items-start justify-between">
            <div className="flex-1 pr-6">
              <div className="flex items-center mb-2">
                <span className="marg-5 inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800 mr-3">
                  {report.type}
                </span>
              ...
              <div className="flex items-center space-x-4 text-sm text-gray-500">
                {report.pages && (
                  <span className="flex items-center marg-5">
            ...
            {[...Array(6)].map((_, i) => (
              <div key={i} className="animate-pulse">
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                  <div className="h-48 bg-gradient-to-br from-indigo-50 to-pink-50"></div>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="p-5 py-12 text-center">
          ...
          Consumer Goods & Services Market Research Reports
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            In-depth analysis of consumer behavior, retail trends, loyalty programs, digital commerce, and innovative services transforming the consumer landscape
          </p>
        </div>
        ...
        {displayedReports.length > 0 ? (
          ...
          <div className="text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-2">No consumer goods & services reports found</h3>
        ...
        <div className="border-t border-gray-200 pt-8 pb-12">
          <div className="text-center">
            <p className="text-lg text-gray-600">
              <span className="font-semibold text-indigo-600">{reports.length}</span> consumer goods & services market research reports available
            </p>
            <p className="text-sm text-gray-500 mt-2">
              Covering retail innovation, loyalty programs, e-commerce trends, fitness technology, security systems, and consumer behavior insights
            </p>
          </div>
        </div>
      </div>
...
export default ConsumerGoodsServicesReportsPage;