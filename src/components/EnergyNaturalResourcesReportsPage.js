// src/components/EnergyNaturalResourcesReportsPage.js
import React, { useState, useEffect } from 'react';
import { Link } from 'react-router-dom';
import { useTranslation } from 'react-i18next';
// Import the JSON data directly
import energyNaturalResourcesData from '../data/energy.json';

const EnergyNaturalResourcesReportsPage = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      setReports(energyNaturalResourcesData);
      setLoading(false);
    }, 300);
  }, []);
            ...
            {[...Array(6)].map((_, i) => (
              <div key={i} className="animate-pulse">
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                  <div className="h-48 bg-gradient-to-br from-green-50 to-yellow-50"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="p-5 py-12 text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
           Energy & Natural Resources Market Research Reports
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Comprehensive analysis of energy markets, renewable technologies, mining solutions, and natural resource management driving the sustainable future
          </p>
        </div>
        ...
        {displayedReports.length > 0 ? (
          ...
          <div className="text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-2">No energy & natural resources reports found</h3>
        ...
        <div className="border-t border-gray-200 pt-8 pb-12">
          <div className="text-center">
            <p className="text-lg text-gray-600">
              <span className="font-semibold text-green-600">{reports.length}</span> energy & natural resources market research reports available
            </p>
            <p className="text-sm text-gray-500 mt-2">
              Covering renewable energy, battery technologies, mining solutions, power generation, and sustainable resource management
            </p>
          </div>
        </div>
      </div>
...
export default EnergyNaturalResourcesReportsPage;