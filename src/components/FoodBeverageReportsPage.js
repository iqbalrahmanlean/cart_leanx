// src/components/FoodBeverageReportsPage.js
import React, { useState, useEffect } from 'react';
import { Link } from 'react-router-dom';
import { useTranslation } from 'react-i18next';
// Import the JSON data directly
import foodBeverageData from '../data/food.json';

const FoodBeverageReportsPage = () => {
  ...
  const ListItem = ({ report }) => {
    ...
    return (
      <div className="bg-white rounded-lg border border-gray-200 hover:shadow-lg transition-all duration-300 hover:border-red-200">
        <div className="p-6">
          <div className="flex items-start justify-between">
            <div className="flex-1 pr-6">
              <div className="flex items-center mb-2">
                <span className="marg-5 inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800 mr-3">
                   {report.type}
                 </span>
            ...
            {[...Array(6)].map((_, i) => (
              <div key={i} className="animate-pulse">
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                  <div className="h-48 bg-gradient-to-br from-red-50 to-orange-50"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="p-5 py-12 text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
           Food & Beverage Market Research Reports
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Comprehensive analysis of food trends, beverage markets, nutrition science, and agricultural innovations shaping the global food industry
          </p>
        </div>
        ...
        {displayedReports.length > 0 ? (
            ...
            {hasMoreReports && (
              <div className="text-center">
                <button 
                  ...
                  className="text-white bg-gradient-to-r from-red-600 to-orange-600 px-8 py-3 rounded-lg hover:from-red-700 hover:to-orange-700 transition-all duration-300 font-medium shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  Load More Reports
                </button>
              </div>
          ...
          <div className="text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-2">No food & beverage reports found</h3>
        ...
        <div className="border-t border-gray-200 pt-8 pb-12">
          <div className="text-center">
            <p className="text-lg text-gray-600">
              <span className="font-semibold ">{reports.length}</span> food & beverage market research reports available
            </p>
            <p className="text-sm text-gray-500 mt-2">
              Covering nutrition trends, food security, beverage innovation, agricultural technology, and consumer health insights
            </p>
          </div>
        </div>
      </div>
...
export default FoodBeverageReportsPage;